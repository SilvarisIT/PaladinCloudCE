...
public class KeyPublicAccesRule extends BaseRule {

    private static final Logger logger = LoggerFactory.getLogger(KeyPublicAccesRule.class);
            ...
            if (!bindings.isEmpty()) {
                for (int i = 0; i < bindings.size(); i++) {
                    ...
                    for(int j=0;j<members.size();j++){
                        ...
                        if(member!=null && member.equalsIgnoreCase(PacmanRuleConstants.ALL_USERS)){
